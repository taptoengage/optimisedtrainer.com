      ...
      >
        <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl ring-1 ring-black/5">
          <div className="px-6 pt-6 pb-4">
            ...
            <button
              onClick={() => window.location.href = 'https://optimisedtrainer.online/auth'}
              className="mt-6 w-full flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 font-semibold text-gray-700 shadow hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600"
            >
