...
export const BenefitsSection: React.FC = () => {
  const trainerBenefits = [
    {
      icon: (
          <svg viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 flex-shrink-0">
  ...
  return (
    <section className="flex w-full flex-col items-start min-h-[653px] bg-[rgba(248,250,252,0.20)] px-72 py-20 lg:px-60 md:px-40 max-md:px-10 max-sm:px-5 border-2 border-red-500">
        ...
        <article className="flex flex-col items-start gap-7 flex-[1_0_0] relative max-sm:gap-5">
          <div className="flex flex-col items-start self-stretch relative">
            <img
              ...
              className="w-full h-[200px] lg:h-[180px] md:h-[160px] max-md:h-[140px] max-sm:h-[120px] shrink-0 self-stretch object-cover rounded-[14px]"
            />
