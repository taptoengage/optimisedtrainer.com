...
export const FeaturesSection: React.FC = () => {
  const features = [
    {
      icon: (
        <svg viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 flex-shrink-0">
  ...
  return (
    <section className="flex w-full flex-col items-start min-h-[483px] bg-[rgba(248,250,252,0.30)] px-72 py-20 lg:px-60 md:px-40 max-md:px-10 max-sm:px-5 border-2 border-red-500">
        ...
        <div className="flex justify-center items-start gap-[42px] self-stretch relative max-md:flex-col max-md:gap-6 max-sm:gap-4">
          {features.map((feature, index) => (
            <article key={index} className="flex-1 self-stretch relative flex flex-col items-center max-md:w-full">
              ...
              <h3 className="flex flex-col items-center relative mb-3.5">
